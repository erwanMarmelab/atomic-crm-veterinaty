 ...
 * transfers all associated notes from the loser to the winner,
...
export const mergeContacts = async (
  ...
  // 1. Reassign all notes from loser to winner
  ...
  // 2. Update winner contact with loser data
  ...
  // Execute all updates
  await Promise.all([...noteUpdates, winnerUpdate]);

  // 3. Delete the loser contact
