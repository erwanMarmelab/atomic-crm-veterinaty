...
grant all on table public.consultations_summary to anon;
grant all on table public.consultations_summary to authenticated;
grant all on table public.consultations_summary to service_role;
